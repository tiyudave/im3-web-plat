...
export function useData() {
  const URL_PREFIX = '/plat/v1/admins'
  ...
  const columns: TableColumnList = [
    ...
    { label: '用户名称', prop: 'name', minWidth: 120, width: 120 },
    { label: '用户昵称', prop: 'nickname', minWidth: 120, width: 120 },
    { label: '电子邮件', prop: 'mail', minWidth: 120, width: 120 },
    { label: '电话号码', prop: 'phone', minWidth: 120, width: 120 },
    { label: '最后登录时间', prop: 'last_login_at', minWidth: 120, width: 120 },
    { label: '登录次数', prop: 'login_count', minWidth: 120, width: 120 },
